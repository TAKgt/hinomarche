...
alter table outbound_clicks add constraint outbound_clicks_surface_check
  check (surface is null or surface in ('home', 'category', 'feature', 'region', 'related', 'search', 'popular', 'recommended', 'product'));
...
alter table product_impressions add constraint product_impressions_surface_check
  check (surface in ('home', 'category', 'feature', 'region', 'related', 'search', 'popular', 'recommended'));

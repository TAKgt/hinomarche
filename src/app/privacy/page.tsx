...
const sections = [
  ...
  },
  {
    title: "取得する情報と利用目的",
    body: [
      "当サイトは、会員登録等でご利用者の個人情報を取得することはありません。お問い合わせをいただいた場合に限り、返信に必要な範囲でメールアドレス等の連絡先情報を取得し、お問い合わせへの対応のみに利用します。",
  ...
  },
  {
    title: "アクセス解析について",
    body: [
      "当サイトは、サイト改善のためにアクセス解析ツールを利用する場合があります。アクセス解析ツールはトラフィックデータの収集のためにCookieを使用することがありますが、このデータは匿名で収集されており、個人を特定するものではありません。利用を開始した場合は、本ページに追記します。",
    ],
  },
  {

...
export const FEATURES: FeatureDefinition[] = [
  ...
  },
  {
    ...
    description:
      "お礼、お祝い、季節のご挨拶などに選びやすい品を、価格・販売先レビュー・AI日本度の根拠とともに紹介します。",
  ...
  },
  {
    ...
    selectionGuide: {
      ...
      description:
        "ティーバッグ、粉末、茶葉の違いに加えて、茶の名称、原料原産地、内容量を確認すると、候補を比べやすくなります。",
      points: [
        {
          title: "淹れ方から商品の形を選ぶ",
          description:
            "商品名や販売ページで、ティーバッグ、粉末、茶葉のどれに当たるかを確認します。抽出方法や必要な道具も販売ページで確かめてください。",
        },
        {
          title: "茶の名称と原料原産地を確認する",
          description:
            "粉末の商品でも名称は一律ではありません。また、仕上げや包装をした場所と、原料となる茶葉の産地は同じとは限りません。正確な名称と原料原産地は販売ページで確認してください。",
        },
        {
          title: "内容量と個数を比べる",
          description:
            "茶葉や粉末はグラム数、ティーバッグは1袋あたりの個数も確認します。セット商品は入り数を含め、必要な量に合うかを比べてください。",
        },
      ],
      officialLinks: [
        {

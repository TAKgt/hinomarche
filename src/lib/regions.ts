...
export const REGIONS: RegionDefinition[] = [
  ...
  },
  {
    ...
    description:
      "商品名に「今治」の表記があるフェイスタオル、バスタオル、ギフトセット、ふるさと納税の返礼品を、用途別に比較できます。",
    titleTerms: ["今治"],
    minScore: 80,
    selectionGuide: {
      title: "今治タオルを用途から比べる3つの視点",
      description:
        "自宅用、贈りもの、ふるさと納税では確認したい条件が異なります。用途を先に決めてから、サイズや枚数、価格を比較します。",
      points: [
        {
          title: "普段使いはサイズと枚数",
          description:
            "フェイスタオル、バスタオル、ミニバスタオルなどの種類と寸法、セット枚数を確認し、洗濯頻度や収納場所に合うものを選びます。",
        },
        {
          title: "ギフトは内容と包装",
          description:
            "贈る相手や場面に合わせ、タオルの組み合わせ、箱や包装の有無、のし対応などを販売ページで確認してください。",
        },
        {
          title: "ふるさと納税は寄付条件",
          description:
            "寄付金額だけでなく、返礼品の枚数・色、発送時期、申込条件を確認し、通常購入の商品と分けて比較します。",
        },
      ],
      relatedLink: {
